...
После изменения MAC-адресов BMC автоматически перезагружается с новыми адресами.

Если в микросхеме FRU ID указанных данных нет, то MAC-адреса сбрасываются на адреса по умолчанию.
