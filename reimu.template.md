...
@TEMPLATE=INTRO@ для проведения действий с модулем на основе процессора Эльбрус-8С или Эльбрус-8СВ (далее «системный модуль», «система», «управляемая машина»). При этом системный модуль может быть выключен, достаточно подать на него STANDBY-питание.
