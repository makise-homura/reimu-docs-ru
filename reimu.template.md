...
* Ethernet 0: IP `192.168.1.1` (префикс 24), MAC `98:A7:B0:00:00:01` (при отсутствии корректного MAC-адреса во FRU ID).
* Ethernet 1: IP `192.168.2.1` (префикс 24), MAC `98:A7:B0:00:00:02` (при отсутствии корректного MAC-адреса во FRU ID).
